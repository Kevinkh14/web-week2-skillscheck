...
// Create an object called 'me' that has these keys with the correct values: firstName, state, age, greeter. firstName will be your 
//name as a string. state will be your current state or providence as a string. age will be your age as a number. 
...
//create an empty array called myNumbersIndex. Next, using forEach, push each items index from the myNumbers array to the myNumbersIndex array

// Code Here
const myNumbersIndex =[];
myNumbers.forEach(function(element,item){
...
// Code Here
var enemies = people.filter(people=>people.friend===false)
...
// Code Here
const totallyAwesome = people.reduce((a,b)=>a+b)